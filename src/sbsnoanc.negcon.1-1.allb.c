...
/******/
				if(codres[0]==0.0 && codres[4]==0.0) /* synsite=0.0 & nonsite=0.0 */
				{
					;
				}
				else if(codres[0]>0.0 && codres[4]==0.0) /* syn/non=infinite */
				{
					wsynsite=1.0;
					wconsite=0.0;
					goto owari10000;
				}
				else if(codres[4]>0.0)
				{
					if(maxsynnon<(codres[0]/codres[4]))
					{
						maxsynnon=(codres[0]/codres[4]);
						wsynsite=codres[0];
						wconsite=codres[4];
					}
				}
