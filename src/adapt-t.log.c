...
/******
					...
					if(tvalue>1.96)
					{
						printf("\t\t%.20f \tP\t", tvalue); fflush(stdout);
					}
					else if((-1.96<=tvalue) && (tvalue<=1.96))
					{
						printf("\t\t%.20f \tN\t", tvalue); fflush(stdout);
					}
					else if(tvalue<-1.96)
					{
						printf("\t\t%.20f \tA\t", tvalue); fflush(stdout);
					}
******/
/****** ******/ 
...
/******/
					...
					printf("%f\t%.20f\t", posprob, negprob); fflush(stdout);
...
******/
					if(totprob<0.05)
					{
						if(flgsel=='n')
						{
							printf("%.20f\tP", -1.0*totprob); fflush(stdout); /****** Purifying selection ******/
						...
						{
							printf("%.20f\tA", totprob); fflush(stdout); /****** Advantageous selection ******/
...
******/
					...
					else if(totprob>=0.05)
					{
						if(flgsel=='n')
						{
							printf("%.20f\tN", -1.0*totprob); fflush(stdout);
							printf("\t%.20f\n", -1.0*(1.0-totprob)); fflush(stdout);
							++dsdn;
						}
						else if(flgsel=='p')
						{
							printf("%.20f\tN", totprob); fflush(stdout);
							printf("\t%.20f\n", 1.0-totprob); fflush(stdout);
							++dnds;
/******
printf("%d\n", siten); fflush(stdout);
